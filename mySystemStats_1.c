...
/*Finally outputing the information about the system with the required command*/
void printSystemStats(int sample, int inerval, bool system_chose, bool graph_chose, bool user_chose, bool sequential_chose){

    printf("Nbr of samples: %d -- every %d secs\n", sample, inerval); // Display number of samples and delay
